<?php
$page_title = 'Bienvenido a la página de inicio';
include_once 'partials/header.php';
error_reporting(0);
?>
    <div class="w-full text-center flex justify-center">
    <?php $content['h1'] = 'MangaWorld'; include('partials/h1.php'); ?>
    </div>
    <br>
    <div class="w-full text-center flex justify-center">
        <img class="ms-auto flex justify-center items-center w-80" src="/images/hero-img.jpg">
    </div>
    <br>
    <div class="w-full text-center flex justify-center">
        <p class="mb-6 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">¿Te gustan los mangas?, aquí podras disfrutar de ellos</p>
    </div>
